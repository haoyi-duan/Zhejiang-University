...
# Model Imports #
from models.xlmr_basic import *
from models.XLMRoberta_CNN import *
from models.XLMRAttentionClasswise import *
# Utils Imports #
...
### Tokenize Data ###
tokens_train = xlmr_tokenize(train_x, args.max_seq_len, base=args.base)
tokens_val = xlmr_tokenize(val_x, args.max_seq_len, base=args.base)
tokens_dev = xlmr_tokenize(sentences_dev, args.max_seq_len, base=args.base)
...
### Model Preparation ###
if args.model_to_use=="xlmr_attn":
    model = XLMRobertaAttention(freeze_bert_params=False, dropout_prob=args.dropout_prob, base=args.base)
elif args.model_to_use=="xlmr_attn_classwise":
    model = XLMRAttentionClasswise(freeze_bert_params=False, dropout_prob=args.dropout_prob, base=args.base)
elif args.model_to_use=="xlmr_cnn":
    model = XLMRobertaCNN(freeze_bert_params=False, dropout_prob=args.dropout_prob, base=args.base)
...
elif args.model_to_use=="xlmr_attn":
    model = train_v2(model, train_dataloader, val_dataloader, args.device, args.epochs, 
                lr1=args.learning_rate, lr2=args.learning_rate_embeddings, loss_type=args.loss_type)
