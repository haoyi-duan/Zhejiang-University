...
class XLMRobertaCNN(nn.Module):
    def __init__(self, freeze_bert_params=True, dropout_prob=0.1, base='xlm-roberta-base'):
      super(XLMRobertaCNN, self).__init__()
      print("XLMRoberta CNN Being Used!!!\n\n\n")
      self.embeddings = XLMRobertaModel.from_pretrained(base)#, output_hidden_states = True)
      ...
      self.fc1 = LinearBlock(embedding_dim,384)
      self.fc2 = LinearBlock(384,384)

      # softmax activation functions
      self.out_shared = LinearBlock(384, 192)
    ...
    def forward(self, sent_id, mask):
      ...
      shared_x = self.out_shared(x) # (32, 192)
