...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L dist_mem_gen_v8_0_12 -L util_vector_logic_v2_0_1 -L blk_mem_gen_v8_4_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Exp1_GPIO xil_defaultlib.Exp1_GPIO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Exp1_GPIO -key {Behavioral:sim_1:Functional:Exp1_GPIO} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Exp1_GPIO.wdb xsim.dir)
